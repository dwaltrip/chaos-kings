...
function registerGameplayWsHandlers(register: RegisterFn): void {
  register(GAMEPLAY_DOMAIN, (data, wsActions) => {
    const msg = data as GameplayServerInbound;
