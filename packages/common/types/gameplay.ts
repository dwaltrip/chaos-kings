...
type GameplayServerInbound = Omit<WsServerInbound, 'domain' | 'type' | 'payload'> & {
  domain: typeof GAMEPLAY_DOMAIN;
} & GameplayInbound;

function isGameplayServerInbound(data: WsServerInbound): data is GameplayServerInbound {
