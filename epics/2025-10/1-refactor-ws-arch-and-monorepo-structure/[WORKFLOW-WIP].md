...
- Exploring architectural decisions that need detailed Q&A
- Detailed analysis of existing code before refactoring
- Implementation sessions with 5+ distinct tasks
- **Don't create for:** Simple bug fixes, small doc updates, quick clarifications
...
## Pending Adjustments
*(None currently - add workflow improvement ideas here)*
