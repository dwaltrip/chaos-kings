...
export function isSquareVisible(coord: Coord, visibleSquares: Set<Coord>, currentPlayerIndex: number | null): boolean {
  if (currentPlayerIndex === null) return true;
  return Array.from(visibleSquares).some(visibleCoord => 
